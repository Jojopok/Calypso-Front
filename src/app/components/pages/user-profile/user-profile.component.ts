...
@Component({
  ...
  imports: [ReactiveFormsModule, InputFieldComponent, AvatarComponent]
})
    ...
    if (userId) {
      this.userService.getUserById(userId).subscribe(
        (userData: User) => {
          ...
          this.userAvatarUrl = userData.avatarUrl || 'path/to/default-avatar.jpg'; // Définissez une URL par défaut si nécessaire
        },
        (error: Error) => {
